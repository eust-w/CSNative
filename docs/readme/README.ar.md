...
<p align="center">
  الصينية هي اللغة الافتراضية. انقر على علم لفتح نسخة Markdown باللغة المناسبة.
</p>
...
اللغة الافتراضية في CS Native هي الصينية، ويدعم `zh-CN` و`en` و`ko` و`ar` و`de` و`fr` و`la`.

- تطبيق سطح المكتب: اختيار اللغة في الشريط الجانبي.
- GitHub Pages: اختيار اللغة في أعلى الصفحة.
- README: روابط أعلام ثابتة، لأن GitHub Markdown لا يشغل سكربتات تبديل اللغة.
